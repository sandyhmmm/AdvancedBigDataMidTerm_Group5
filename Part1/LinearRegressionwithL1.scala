...
object LinearRegressionWithSGDL1 {
  def main(args: Array[String]) {

    val conf = new SparkConf().setAppName("LinearRegressionWithSGDL1")
...
//val model = LinearRegressionWithSGD.train(training,numIterations,0.00001)
